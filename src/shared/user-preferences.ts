...
const localStorageID = "user-preferences::v1";
...
const userPreferences = JSON.parse(
  localStorage.getItem(localStorageID) || '{theme: "light", lang: "en"}'
) as IUserPreferences;
...
class changeUserPreference {
  ...
  private saveChanges() {
    localStorage.setItem(localStorageID, JSON.stringify(userPreferences));
  }
}
